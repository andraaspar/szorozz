...
var sz;
(function (sz) {
    var AppcacheModel = (function (_super) {
        __extends(AppcacheModel, _super);
        function AppcacheModel() {
            _super.call(this);
            this.supportsAppCache = !!window.applicationCache;
            this.hasUpdateError = false;
        }
        AppcacheModel.prototype.init = function () {
        ...
        AppcacheModel.prototype.onCached = function (e) {
            this.onAfterCache();
        };
        AppcacheModel.prototype.onNoUpdate = function (e) {
            this.onAfterCache();
        };
        AppcacheModel.prototype.onUpdateReady = function (e) {
            window.location.reload();
        };
        AppcacheModel.prototype.onError = function (e) {
            this.hasUpdateError = true;
            this.onAfterCache();
        };
        AppcacheModel.prototype.onAfterCache = function () {
            new illa.Event(AppcacheModel.EVENT_READY, this).dispatch();
        };
        AppcacheModel.prototype.getHasUpdateError = function () {
            return this.hasUpdateError;
        };
        AppcacheModel.prototype.getSupportsAppcache = function () {
            return this.supportsAppCache;
        };
        AppcacheModel.EVENT_READY = 'sz_model_AppcacheModel_EVENT_READY';
        return AppcacheModel;
    })(illa.EventHandler);
    sz.AppcacheModel = AppcacheModel;
})(sz || (sz = {}));
var sz;
(function (sz) {
    ...
    sz.LanguageEnglish = LanguageEnglish;
})(sz || (sz = {}));
var sz;
(function (sz) {
    ...
    sz.LanguageHungarian = LanguageHungarian;
})(sz || (sz = {}));
var sz;
(function (sz) {
    var SzorozzModel = (function (_super) {
        __extends(SzorozzModel, _super);
        function SzorozzModel() {
            _super.call(this);
            this.count = 0;
            this.factors = [NaN, NaN];
        }
        SzorozzModel.prototype.newQuestion = function () {
            this.count++;
        ...
        SzorozzModel.prototype.getRandomFactors = function () {
            var r = [this.getRandomFactor(), this.getRandomFactor()];
        ...
        SzorozzModel.prototype.getRandomFactor = function () {
            return Math.round(Math.random() * 10.999 - .5);
        };
        SzorozzModel.prototype.getOperator = function () {
            return this.operator;
        };
        SzorozzModel.prototype.getFactors = function () {
            return this.factors;
        };
        SzorozzModel.prototype.getProduct = function () {
            return this.product;
        };
        SzorozzModel.prototype.getDividend = function () {
            return this.product;
        };
        SzorozzModel.prototype.getDivisor = function () {
            return this.factors[0];
        };
        SzorozzModel.prototype.getQuotient = function () {
            return this.factors[1];
        };
        SzorozzModel.prototype.isResultCorrect = function (result) {
        ...
        SzorozzModel.prototype.getCount = function () {
            return this.count;
        };
        SzorozzModel.OPERATOR_MULTIPLY = 'multiply';
        SzorozzModel.OPERATOR_DIVIDE = 'divide';
        return SzorozzModel;
    })(illa.EventHandler);
    sz.SzorozzModel = SzorozzModel;
})(sz || (sz = {}));
var sz;
(function (sz) {
    var SzorozzView = (function (_super) {
        __extends(SzorozzView, _super);
        function SzorozzView(jq) {
            _super.call(this, jq);
            this.getJQuery().html(illa.Arrkup.createString([
                ['div', { 'class': 'sz-wrapper' }, ['span', { 'class': 'sz-count', 'data-berek-widget-part': 'countOut' }]],
                ['div', { 'class': 'sz-wrapper' }, ['span', { 'class': 'sz-question', 'data-berek-widget-part': 'questionOut' }], ' ', ['input/', { 'class': 'sz-input', 'type': 'number', 'data-berek-widget-part': 'resultIn' }], ' ', ['button', { 'class': 'sz-button', 'type': 'button', 'data-berek-widget-part': 'doneButton' }, sz.Main.getLanguage().doneButtonLabel]],
    ...
    sz.SzorozzView = SzorozzView;
})(sz || (sz = {}));
/// <reference path='SzorozzView.ts'/>
var sz;
(function (sz) {
    var SzorozzPresenter = (function () {
        function SzorozzPresenter() {
            this.szorozzModel = new sz.SzorozzModel();
            this.szorozzView = new sz.SzorozzView(jQuery('body'));
        ...
        SzorozzPresenter.prototype.onDoneButtonClicked = function (e) {
            this.checkResult();
        };
        SzorozzPresenter.prototype.onKeyUp = function (e) {
            if (e.which == 13) {
                this.checkResult();
            }
        };
        SzorozzPresenter.prototype.onChangeLanguageButtonClicked = function (e) {
            sz.Main.setLanguage(sz.Main.getLanguage() instanceof sz.LanguageEnglish ? new sz.LanguageHungarian() : new sz.LanguageEnglish());
        };
        SzorozzPresenter.prototype.ask = function () {
            this.szorozzModel.newQuestion();
            var question;
            switch (this.szorozzModel.getOperator()) {
                case sz.SzorozzModel.OPERATOR_MULTIPLY:
                    question = this.szorozzModel.getFactors()[0] + ' ' + sz.Main.getLanguage().multiply + ' ' + this.szorozzModel.getFactors()[1] + ' =';
                    break;
                case sz.SzorozzModel.OPERATOR_DIVIDE:
                    question = this.szorozzModel.getDividend() + ' ' + sz.Main.getLanguage().divide + ' ' + this.szorozzModel.getDivisor() + ' =';
                    break;
            }
        ...
        SzorozzPresenter.prototype.checkResult = function () {
            if (this.szorozzModel.isResultCorrect(parseInt(this.szorozzView.resultIn.val()))) {
                this.szorozzView.feedbackOut.text(sz.Main.getLanguage().answerCorrect);
                this.ask();
            }
            else {
                this.szorozzView.feedbackOut.text(sz.Main.getLanguage().answerIncorrect);
                this.szorozzView.resultIn.val('').focus();
            }
            this.szorozzView.feedbackOut.stop(true, true).fadeOut(0).fadeIn(250).delay(2000);
        };
        return SzorozzPresenter;
    })();
    sz.SzorozzPresenter = SzorozzPresenter;
})(sz || (sz = {}));
...
(function (sz) {
    var Main = (function () {
        ...
        Main.prototype.onDomLoaded = function () {
            ...
            this.appcacheModel = new sz.AppcacheModel();
            this.appcacheModel.addEventCallback(sz.AppcacheModel.EVENT_READY, this.onAppcacheReady, this);
            this.appcacheModel.init();
        };
        Main.prototype.onAppcacheReady = function (e) {
            illa.Log.info('Appcache ready.');
            this.szorozzPresenter = new sz.SzorozzPresenter();
        };
        Main.prototype.chooseLanguage = function () {
            var detected = '';
            try {
            ...
            switch (detectedArr[0]) {
                case 'hu':
                    this.language = new sz.LanguageHungarian();
                    break;
                default:
                    this.language = new sz.LanguageEnglish();
            }
        };
        Main.getLanguage = function () {
            return this.instance.language;
        };
        Main.setLanguage = function (v) {
            this.instance.language = v;
            jQuery('body').empty();
            this.instance.szorozzPresenter = new sz.SzorozzPresenter();
        };
